...
import de.krakel.darkbeam.testing.DarkBeamTesting;
import de.krakel.darkbeam.testing.client.renderer.BlockRedWireRender;
...
//	private boolean mProvidePower = true;
	public BlockRedWire( int id) {
		super( id, DarkBeamTesting.MAT_DARK);
	...
	public void breakBlock( World world, int x, int y, int z, int id, int meta) {
		LogHelper.info( "%b, %s, id=%d, meta=%d", world.isRemote, LogHelper.toString( x, y, z), id, meta);
...
//				if (TileRedWire.isSet( tile.mConnections, dir)) {
	...
	public boolean canPlaceBlockAt( World world, int x, int y, int z) {
		LogHelper.info( "%b, %s", world.isRemote, LogHelper.toString( x, y, z));
		for (ForgeDirection dir : ForgeDirection.VALID_DIRECTIONS) {
	...
	public boolean canPlaceBlockOnSide( World world, int x, int y, int z, int side) {
		LogHelper.info( "%b, %s, side=%d", world.isRemote, LogHelper.toString( x, y, z), side);
