...
public final class FReferences {
	...
	public static final String CLASS_CLIENT_PROXY = "de.grayal.darkbeam.core.proxy.ClientProxy";
	public static final String CLASS_SERVER_PROXY = "de.grayal.darkbeam.core.proxy.CommonProxy";
